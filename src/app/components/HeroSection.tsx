...
export function HeroSection() {
  return (
    <section className="relative w-full overflow-hidden" style={{ fontFamily: "Inter, system-ui, sans-serif" }}>
      ...
      {/* Content */}
      <div className="relative z-10 px-6 sm:px-10 lg:px-16 py-12 sm:py-16 lg:py-20 min-h-[calc(100vh-48px)] sm:min-h-[calc(100vh-48px)] lg:min-h-[calc(100vh-48px)] flex flex-col justify-start pt-16 sm:pt-20 lg:pt-24">
        <div className="max-w-[600px]">
          ...
          >
            <span className="block text-[38px] sm:text-[52px] lg:text-[68px]">Start Strong,</span>
            <span className="block text-[38px] sm:text-[52px] lg:text-[68px]">Fight Mutations</span>
          </h1>
