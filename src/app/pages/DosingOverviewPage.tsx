...
function AnchorNav() {
  ...
  return (
    <nav className="sticky top-[88px] z-20 w-full bg-[#F5F7FA] border-b border-[#E3E8EF] overflow-x-auto">
...
export function DosingOverviewPage() {
  ...
  return (
    <div className="flex-1 bg-white min-w-0">
      ...
      <section id="convenient" className="scroll-mt-[140px] max-w-[1200px] mx-auto px-6 md:px-10 lg:px-12 py-8 md:py-12">
        <div className="max-w-4xl">
      ...
      <section id="dosingstrategy" className="scroll-mt-[140px] max-w-[1200px] mx-auto px-6 md:px-10 lg:px-12 pb-8 md:pb-12">
        <div className="max-w-4xl">
      ...
      <section id="dosemodification" className="scroll-mt-[140px] max-w-[1200px] mx-auto px-6 md:px-10 lg:px-12 pb-8 md:pb-12">
        <div className="max-w-4xl">
          <h2 className="text-[#1B2430] text-[18px] md:text-[22px] lg:text-[26px] font-[700] leading-snug mb-6">
            Guidance for dose modifications
          </h2>
