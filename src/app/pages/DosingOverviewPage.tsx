...
export function DosingOverviewPage() {
  ...
  return (
    <div className="flex-1 bg-white min-w-0">
      ...
      <section id="convenient" className="scroll-mt-[140px] px-8 md:px-20 xl:px-32 py-8 md:py-12">
        <div className="max-w-4xl">
      ...
      <section id="dosingstrategy" className="scroll-mt-[140px] px-8 md:px-20 xl:px-32 pb-8 md:pb-12">
        <div className="max-w-4xl">
      ...
      <section id="dosemodification" className="scroll-mt-[140px] px-8 md:px-20 xl:px-32 pb-8 md:pb-12">
        <div className="max-w-4xl">
          <h2 className="text-[#1B2430] text-[18px] md:text-[22px] lg:text-[26px] font-[700] leading-snug mb-6">
            Guidance for dose modifications
          </h2>
