...
export function PhAllFirstLinePage() {
  ...
  return (
    <div className="flex-1 bg-white min-w-0">
      ...
      {/* STUDY DESIGN                                                  */}
      {/* ============================================================ */}
      <section id="study" className="px-4 md:px-8 lg:px-12 py-8 md:py-12">
        <div className="max-w-4xl">
      ...
      <section
        id="efficacy"
        className="px-4 md:px-8 lg:px-12 py-8 md:py-12 bg-[#F5F7FA]"
      >
        <div className="max-w-4xl">
          <h2 className="text-[#1B2430] text-[18px] md:text-[22px] lg:text-[26px] font-[700] leading-snug mb-4">
      ...
      {/* SAFETY PROFILE                                                */}
      {/* ============================================================ */}
      <section id="safety" className="px-4 md:px-8 lg:px-12 py-8 md:py-12">
        <div className="max-w-4xl">
